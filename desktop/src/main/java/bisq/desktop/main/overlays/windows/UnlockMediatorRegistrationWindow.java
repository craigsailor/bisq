...
public class UnlockMediatorRegistrationWindow extends Overlay<UnlockMediatorRegistrationWindow> {
    ...
    public UnlockMediatorRegistrationWindow(boolean useDevPrivilegeKeys) {
    ...
    public void show() {
        ...
        if (headLine == null)
            headLine = Res.get("enterPrivKeyWindowMediator.headline");
    ...
    public UnlockMediatorRegistrationWindow onKey(PrivKeyHandler privKeyHandler) {
